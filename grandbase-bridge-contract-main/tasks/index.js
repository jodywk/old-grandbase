...
task("ocGetOracle", "get the Oracle address being used by the OmniCounter", 
        require("./ocGetOracle"))
    .addParam("targetNetwork", "the target network name, ie: fuji, or mumbai, etc (from hardhat.config.js)")
...
task("swapNativeForNative", "swap native on one chain thru StargateComposed to native on another chainr", 
        require("./swapNativeForNative"))
...
task("approveERC1155", "approve it to transfer my nfts", require("./approveERC1155"))
    .addParam("addr", "the address to approve")
...
task(
    "setTrustedRemoteAll",
    "setTrustedRemote(chainId, sourceAddr) to enable inbound/outbound messages with your other contracts",
    require("./setTrustedRemoteForAll")
)
    .addParam("task", "Specify Testnet or Mainnet")
    .addOptionalParam("localContract", "Name of local contract if the names are different")
    .addOptionalParam("remoteContract", "Name of remote contract if the names are different")
    .addOptionalParam("contract", "If both contracts are the same name")
...
task("setMinDstGasAll", "set min gas required on the destination gas", require("./setMinDstGasAll"))
    .addParam("packetType", "message Packet type")
    .addParam("task", "Specify Testnet or Mainnet")
    .addParam("contract", "contract name")
    .addParam("minGas", "min gas")
...
task("deployAll", "Deploy contract to already defined chains", require("./deployAllChains"))
    .addParam("contract", "")
    .addParam("task", "Specify Testnet or Mainnet")
